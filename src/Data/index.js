...
export const topHideSideNavigation = [
  {
    icon: IoMdHome,
    title: "Home",
    action: () => {
...
export const NewContainerNavigations = [
  {
    Icon: IoMdHome,
    title: "Home",
    action: () => {
...
export const MiddleNavigations = [
  {
    icon: MdOutlineVideoLibrary,
    title: "Library",
    action: () => {
...
export const MiddleHideNavigations = [
  {
    icon: MdOutlineVideoLibrary,
    title: "Library",
    action: () => {
...
export const MoreHideFromYoutube = [
  {
    icon: AiOutlineYoutube,
    title: "Youtube premium",
    action: () => {
...
export const FooterHideSetting = [
  {
    icon: FiSettings,
    title: "Setting",
    action: () => {
